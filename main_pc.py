...
def communicate(driver):
    job_list = driver.find_element(By.XPATH, '//*[@id="container"]/div[1]/div/div[3]/div/ul').find_elements(By.CLASS_NAME, "job-card-wrapper")
    print('job_list', job_list)
    for job in job_list:
      url = job.find_element(By.CLASS_NAME, 'job-card-body').find_element(By.TAG_NAME, 'a').get_attribute('href')


      job_name = job.find_element(By.XPATH, '//*[@id="container"]/div[1]/div/div[3]/div/ul/li[1]/div[1]/a/div[1]/span[1]').get_attribute('innerText')
      ...
      communicate_btn = driver.find_element(By.XPATH, '//*[@id="main"]/div[1]/div/div/div[1]/div[3]/div[1]/a[2]')

      if communicate_btn.get_attribute('innerText') == '立即沟通':
        communicate_btn.click()
        time.sleep(7)
        driver.find_element(By.XPATH, '/html/body/div[11]/div[2]/div[2]/div/div[1]/div[2]/textarea').send_keys(
    ...
    driver.find_element(By.XPATH, '//*[@id="container"]/div[1]/div/div[3]/div/div/div/div/a[10]').click()
    time.sleep(6)
    communicate(driver)
